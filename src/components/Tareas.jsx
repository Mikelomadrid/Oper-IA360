...
import { ClipboardList, Loader2, ServerCrash, Inbox, Plus, Filter, LayoutGrid, List, ChevronDown, ChevronUp, CheckCircle2 } from 'lucide-react';
    ...
    const grouped = tasksData.reduce((acc, current) => {
      ...
      if (!acc[taskId]) {
        acc[taskId] = {
          ...
          fecha_completada: current.fecha_completado, // Corrected column mapping
